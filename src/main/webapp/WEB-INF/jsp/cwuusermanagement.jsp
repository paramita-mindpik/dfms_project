			...
			<div class="card">
	            <div class="card-body">
	             <form:form cssClass="row" action="#" method="POST" modelAttribute="cddrb" name="angulForm">
                    <div class="col-md-2">
                        <label for="inputState" class="form-label">BEAT Officers</label>
                      ...
                      <div class="col-md-2">
                        <label for="inputState" class="form-label">Range Officers</label>
                      ...
                      <div class="col-md-2">
                        <label for="inputState" class="form-label">ADFOs</label>
                        <select id="inputState" class="form-select">
                          <option selected>Choose...</option>
                          <option>BANKURA NORTH</option>
                        </select>
                      ...
                      <div class="col-md-2">
                        <label for="inputState" class="form-label">DFOs</label>
                        <select id="inputState" class="form-select">
                          <option selected>Choose...</option>
                          <option>BANKURA NORTH</option>
                        </select>
                      ...
                      <div class="col-md-2">
                        <label for="inputState" class="form-label">Circle Officers</label>
                        <select id="inputState" class="form-select">
                          <option selected>Choose...</option>
                      ...
                      <div class="col-md-2">
                        <label for="inputState" class="form-label">PMU WBFBC Project</label>
                        <select id="inputState" class="form-select">
                          <option selected>Choose...</option>
                          <option>1</option>
                          <option>2</option>
                      ...
                      <div class="col-md-2">
                        <label for="inputState" class="form-label">Head Office of Forest Directorate</label>
                        <select id="inputState" class="form-select">
                          <option selected>Choose...</option>
                          <option>BANKURA NORTH</option>
                        </select>
                      ...
                      <div class="col-md-2">
                        <label for="inputState" class="form-label">MIS executives</label>
                        <select id="inputState" class="form-select">
                          <option selected>Choose...</option>
                          <option>BANKURA NORTH</option>
                        </select>
