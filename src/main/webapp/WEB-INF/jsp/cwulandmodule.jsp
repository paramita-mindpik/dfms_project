			...
			<div class="card">
	            <div class="card-body">
	             <form:form cssClass="row" action="#" method="POST" modelAttribute="cddrb" name="angulForm">
                    <div class="col-md-2">
                        <label for="inputState" class="form-label">Legal status</label>
                      ...
                      <div class="col-md-2">
                        <label for="inputState" class="form-label">Compartment No.</label>
                        <select id="inputState" class="form-select">
                          <option selected>Choose...</option>
                          <option>1</option>
                          <option>2</option>
                      ...
                      <div class="col-md-2">
                        <label for="inputState" class="form-label">Plantation</label>
                        <select id="inputState" class="form-select">
                          <option selected>Choose...</option>
