...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Technical Status of Soil</h1>
    </div><!-- End Page Title -->
			...
			<div class="card">
	            <div class="card-body">
	             <form:form cssClass="row" action="#" method="POST" modelAttribute="cddrb" name="angulForm">
	                <div class="col-md-2">
                        <label for="inputState" class="form-label">Soil Erosion</label>
					  ...
					  <div class="col-md-2">
                        <label for="inputState" class="form-label">Soil Type</label>
                        <select id="inputState" class="form-select">
                          <option selected>Choose...</option>
                          <option>Soil PH</option>
                          <option>C/N Ratio</option>
                          <option>N</option>
                          <option>P</option>
                          <option>K</option>
                        </select>
