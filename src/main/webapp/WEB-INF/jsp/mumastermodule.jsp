	            ...
	            <div class="card-body">
	             <form:form cssClass="row" action="#" method="POST" modelAttribute="cddrb" name="angulForm">
                    <div class="col-md-2">
                      ...
                      <div class="col-md-2">
                        <label for="inputState" class="form-label">FPC</label>
                        <select id="inputState" class="form-select">
                          <option selected>Choose...</option>
                          <option>BANKURA NORTH</option>
                        </select>
                      ...
                      <div class="col-md-2">
                        <label for="inputState" class="form-label">Panchayet  Samiti</label>
                        <select id="inputState" class="form-select">
                          <option selected>Choose...</option>
                          <option>BANKURA NORTH</option>
                        </select>
                      ...
                      <div class="col-md-2">
                        <label for="inputState" class="form-label">Gram Panchayet</label>
                        <select id="inputState" class="form-select">
                          <option selected>Choose...</option>
                          <option>BANKURA NORTH</option>
                        </select>
                      ...
                      <div class="col-md-2">
                        <label for="inputState" class="form-label">Scheme</label>
                        <select id="inputState" class="form-select">
                          <option selected>Choose...</option>
                          <option>BANKURA NORTH</option>
                        </select>
